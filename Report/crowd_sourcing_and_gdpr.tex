...
\begin{document}
	...
	\startsection
		...
		%[Source: https://convene.com/catalyst/is-boston-the-smartest-city/ ,Title:Is Boston the Smartest City? ,  Author:By Natalie Holmes , Accessed:05.12.21]
		
		\subsection{BOS:311}
		\startsubsection
		% The one above and [https://311.boston.gov/]
		...
		\subsection{Where's my School bus?}
		\startsubsection
		% The one above and [https://schoolbus.bostonpublicschools.org//]
	...
	Bostons traffic management department partnered with Waze to combat the cities traffic issues. Waze delivers hereby the data of driving app users to the Boston traffic engineers which then adjust the cities traffic signals. The traffic department also sends back this updated information in addition with future planned adjustments to Waze in turn.
		...
		\startsubsection
			...
			%[Source: http://www.streetbump.org/about  ,  Notes:Street Bump has been produced by the Mayor's Office of New Urban Mechanics in Boston., Accessed: 05.12.21]
			%[https://www.boston.gov/departments/innovation-and-technology/street-bump-mobile-application-terms-service, Notes:  Last updated: 6/22/16]
	...
	% The paper also states some possible further applications of MCS
		...
		\startsubsection
			...
			%[Source: https://ieeexplore.ieee.org/document/7180511 ,Title:Security and privacy in mobile crowdsourcing networks: challenges and opportunities , Authors: K. Yang, K. Zhang, J. Ren, and X. Shen]
			...
			%[Source:https://ieeexplore.ieee.org/document/6693368  ,Title: Towards A Framework for Privacy-Aware Mobile Crowdsourcing , Authors: Y. Wang, Y. Huang, and C. Louis]
