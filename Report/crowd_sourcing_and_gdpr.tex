...
\begin{document}
	...
	\chapter{Conclusion}
	In the following chapter design principles and guidelines are presented and the currently used crowd-sourcing methods are evaluated and possible improvements are introduced.
	...
	\startsection
		...
		\begin{enumerate}[(i)]
			...
			\item Inalienable Provenance
			\item Benefit Sharing
			\item Competence and Professionalism
			\item Biological Realism
			\item Cognitive Realism
			\item Longevity
		\end{enumerate}
