...
\begin{document}
	...
	\startsection
		...
		Said chapter answers our first research question \ref{RQ1} %@Marcel, how do i link to the exact question, not the section? This should show the label RQ1 or similar.
		Then we investigate if and how the presented crowd-sourcing methods comply with the GDPR and design the Design Science Research Artifact: A set of design principles and guidelines for designing crowd-sourcing methods in Chapter \ref{Results}. %@Marcel describe here exactly what you did.
		Finally, we perfom a descriptive artifact evaluation, to validate our design principles and guidelines in the same Chapter.
		This answers our second research question \ref{RQ2} %@Marcel, how do i link to the exact question, not the section? This should show the label RQ2 or similar.
	\closesection
